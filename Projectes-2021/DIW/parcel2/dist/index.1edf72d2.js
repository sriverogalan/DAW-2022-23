   ...
   */ defineJQueryPlugin(Collapse);
    ...
    function mapToStyles(_ref2) {
        ...
        if (adaptive) {
            ...
            if (placement === top || (placement === left || placement === right) && variation === end1) {
                sideY = bottom; // $FlowFixMe[prop-missing]
                y -= offsetParent[heightProp] - popperRect.height;
                y *= gpuAcceleration ? 1 : -1;
            }
            if (placement === left || (placement === top || placement === bottom) && variation === end1) {
  ...
  */ function listScrollParents(element, list) {
    ...
    function flip(_ref) {
        ...
        for(var i = 0; i < placements.length; i++){
            ...
            var isStartVariation = getVariation(placement2) === start1;
            var isVertical = [
                top,
                bottom
    ...
    function preventOverflow(_ref) {
        ...
        if (checkMainAxis || checkAltAxis) {
            ...
            var minLen = variation === start1 ? referenceRect[len] : popperRect[len];
            var maxLen = variation === start1 ? -popperRect[len] : -referenceRect[len]; // We need to include the arrow in the calculation so the arrow doesn't go
    ...
    function orderModifiers(modifiers) {
        ...
        var orderedModifiers = order1(modifiers); // order based on phase
...
//# sourceMappingURL=index.1edf72d2.js.map
